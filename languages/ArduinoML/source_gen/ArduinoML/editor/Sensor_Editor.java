...
public class Sensor_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_qb70eh_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_qb70eh_d0(editorContext, node));
  ...
  private EditorCell createConstant_qb70eh_d0(EditorContext editorContext, SNode node) {
